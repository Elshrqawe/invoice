...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('Fatortk.Invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> / {{__('Fatortk.add bill')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    <form action="{{ route('invoices.store') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                         title="اضغط هنا  لئنشاء  رقم الفتوره" required >
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <label for="inputName" class="control-label">  {{__('Fatortk.the product')}} / <span style="color: red"> {{__('Fatortk.The section must be selected first')}}</span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Amount_Commission"
                                       name="Amount_Commission" title="{{__('Fatortk.Please enter the commission amount')}}"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                       required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg" id="Discount" name="Discount"
                                       title="{{__('Fatortk.Please enter the discount amount')}}"
                                       oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');"
                                       value=0 required>
                            </div>
                            ...
                            <div class="col">
                                ...
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" onchange="myFunction()">
                                    <!--placeholder-->
                                    <option value="" selected disabled> {{__('Fatortk.Select the tax rate')}}</option>
                        ...
                        <h5 class="card-title"> {{__('Fatortk.attachments')}}</h5>
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary">{{__('Fatortk.Saving data')}}</button>
                        </div>
...
@section('js')
    ...
    <script>
        function myFunction() {
            ...
            if (typeof Amount_Commission === 'undefined' || !Amount_Commission) {
                ...
                alert(' {{__('Fatortk.Please enter the commission amount')}});
    ...
    <script>
        var generator = function (l) {
            let array = ['-', 'A', 'B', 'C', '6', 'D', 'E', 'F', 'G', '_',
            ...
            for (i = 0; i < l; i++) {
                generated_code = generated_code + array[Math.floor(Math.random() * array.length)];
            }
