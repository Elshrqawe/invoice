...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">{{__('Fatortk.Invoices')}}</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0"> / {{__('Fatortk.Edit invoice')}}</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('invoices.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="inputName" name="invoice_number"
                                       title="{{__('Fatortk.Please enter the invoice number')}}" value="{{ $invoices->invoice_number }}" required>
                            </div>
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button class="btn btn-primary" type="submit">{{__('Fatortk.Saving data')}} </button>
